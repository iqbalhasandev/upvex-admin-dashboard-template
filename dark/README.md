...
# Upvex - The most complete web ui kit and dashboard template

Thank you for purchasing Upvex :). The following guideline will help you to get started with Upvex and its documentation.
