...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var pcolors = ['#f0643b','#675db7'];
		var borderColor = '#3b434e';
		...
		var pcolorsDot = ['#e36498','#5089de'];
		var borderColorDot = '#3b434e';
		...
		var colors = ['#4a81d4','#f672a7','#e3eaef','#f0643b','#56c2d6'];
		this.createPieGraph("#pie-chart #pie-chart-container", pielabels, datas, colors);

		//real time data representation
		var plot = this.createRealTimeGraph('#flotRealTime', this.randomData(), ['#23b397']);
		plot.draw();
		var $this = this;
		function updatePlot() {
		...
		var donutcolors = ['#4a81d4','#f672a7','#e3eaef','#f0643b','#56c2d6'];
		...
		this.createStackBarGraph("#ordered-bars-chart", stack_ticks, ['#e3eaef','#f0643b','#56c2d6'], ds);
		...
		this.createLineGraph("#line-chart-alt", line_ticks, ['#f0643b','#56c2d6'], line_data);
	},
